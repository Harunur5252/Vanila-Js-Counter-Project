...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _data__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./data */ \"./src/modules/data.js\");\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\n\n\nvar UI = /*#__PURE__*/function () {\n  function UI() {\n    _classCallCheck(this, UI);\n  }\n\n  _createClass(UI, [{\n    key: \"selectors\",\n    value: function selectors() {\n      var numberElm = document.querySelector('.number');\n      var decreaseBtnElm = document.querySelector('.dBtn');\n      var resetBtnElm = document.querySelector('.rBtn');\n      var increaseBtnElm = document.querySelector('.iBtn');\n      return {\n        numberElm: numberElm,\n        decreaseBtnElm: decreaseBtnElm,\n        resetBtnElm: resetBtnElm,\n        increaseBtnElm: increaseBtnElm\n      };\n    }\n  }, {\n    key: \"getIncreaseValue\",\n    value: function getIncreaseValue() {\n      var _this$selectors = this.selectors(),\n          numberElm = _this$selectors.numberElm;\n\n      _data__WEBPACK_IMPORTED_MODULE_0__.default.increase++; // console.log(data.increase)\n\n      numberElm.textContent = _data__WEBPACK_IMPORTED_MODULE_0__.default.increase;\n\n      if (_data__WEBPACK_IMPORTED_MODULE_0__.default.increase === 0) {\n        numberElm.style.color = 'black';\n      } else if (_data__WEBPACK_IMPORTED_MODULE_0__.default.increase > 0) {\n        numberElm.style.color = 'green';\n      } else if (_data__WEBPACK_IMPORTED_MODULE_0__.default.increase < 0) {\n        numberElm.style.color = 'red';\n      }\n    }\n  }, {\n    key: \"getDecreaseValue\",\n    value: function getDecreaseValue() {\n      var _this$selectors2 = this.selectors(),\n          numberElm = _this$selectors2.numberElm;\n\n      _data__WEBPACK_IMPORTED_MODULE_0__.default.increase--;\n      numberElm.textContent = _data__WEBPACK_IMPORTED_MODULE_0__.default.increase;\n\n      if (_data__WEBPACK_IMPORTED_MODULE_0__.default.increase < 0) {\n        numberElm.style.color = 'red';\n      }\n\n      if (_data__WEBPACK_IMPORTED_MODULE_0__.default.increase === 0) {\n        numberElm.style.color = 'black';\n      }\n    }\n  }, {\n    key: \"resetValue\",\n    value: function resetValue() {\n      var _this$selectors3 = this.selectors(),\n          numberElm = _this$selectors3.numberElm;\n\n      _data__WEBPACK_IMPORTED_MODULE_0__.default.increase = 0;\n      numberElm.textContent = _data__WEBPACK_IMPORTED_MODULE_0__.default.increase;\n      numberElm.style.color = 'black';\n    }\n  }, {\n    key: \"loadAllEventListener\",\n    value: function loadAllEventListener() {\n      var _this = this;\n\n      var _this$selectors4 = this.selectors(),\n          increaseBtnElm = _this$selectors4.increaseBtnElm,\n          decreaseBtnElm = _this$selectors4.decreaseBtnElm,\n          resetBtnElm = _this$selectors4.resetBtnElm;\n\n      increaseBtnElm.addEventListener('click', function () {\n        return _this.getIncreaseValue();\n      });\n      decreaseBtnElm.addEventListener('click', function () {\n        return _this.getDecreaseValue();\n      });\n      resetBtnElm.addEventListener('click', function () {\n        return _this.resetValue();\n      });\n    }\n  }]);\n\n  return UI;\n}();\n\nvar ui = new UI();\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (ui);\n\n//# sourceURL=webpack://my-webpack-project/./src/modules/ui.js?");
